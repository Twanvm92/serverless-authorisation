/**
 * Created by twanv on 12-4-2019.
 */

// Fill in with your values
const AUTH0_CLIENT_ID = 'cOin2CxuKMH6kHqPDLZUGHbRNFjyY2ni';
const AUTH0_DOMAIN = 'dev-l38mnlmr.eu.auth0.com';
const AUTH0_CALLBACK_URL = window.location.href;
const PUBLIC_ENDPOINT = 'http://localhost:3000';
const PRIVATE_ENDPOINT = 'http://localhost:3000/user';
